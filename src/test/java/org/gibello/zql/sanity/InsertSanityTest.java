...
public class InsertSanityTest extends ZQLTestCase {
	...
	@Test
	public void singleLinePartialInsertsShouldWork() throws ParseException, IOException {
	...
	@Test
	public void singleLineInsertAllColumnsInsertShouldWork() throws ParseException, IOException {
		...
		assertNull(insert.getQuery());
		assertEquals(Arrays.asList(new ZConstant("21", NUMBER), new ZConstant("01", NUMBER), new ZConstant("Ottoman", STRING), new ZConstant("200.00", NUMBER)),
				insert.getValues());
	}
	...
	@Ignore
	@Test
	public void multiLinePartialInsertShouldWork() throws ParseException, IOException {
	...
	@Test
	public void insertSanityCheck1() throws ParseException, IOException {
		final List<ZStatement> statements = parseSQL("INSERT INTO ANTIQUES VALUES (21, 01, 'Ottoman', 200.00);");
		assertEquals("insert into ANTIQUES values (21, 01, 'Ottoman', 200.00)", statements.get(0).toString());
	}

	@Test
	public void insertSanityCheck2() throws ParseException, IOException {
