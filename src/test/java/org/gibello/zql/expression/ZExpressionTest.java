...
import org.gibello.zql.StringProvider;
...
public class ZExpressionTest {
	...
	@Test
	public void zExpressionToStringNPEWhereClauseWithOrOperator() throws ParseException, IOException {
		// given
	...
	@Test
	public void zExpressionToStringNPEWhereClauseWithAndOperator() throws ParseException, IOException {
		// given
	...
	@Test
	public void zExpressionToStringNPEWhereClauseWithInvalidOperator() throws ParseException, IOException {
		// given
	...
	private ZqlJJParser givenAParserForTheSQLExpression(String sqlExpression) {
		return new ZqlJJParser(new StringProvider(sqlExpression));
	}
}