...
public class ZQuery implements ZStatement, ZExp {
	 ...
	 */
	public void addSelect(final List<ZSelectItem> select) {
		this.select = select;
	}
	 ...
	 */
	public void addFrom(final List<ZFromItem> from) {
		this.from = from;
	}
	 ...
	 */
	public void addOrderBy(final List<ZOrderBy> orderby) {
	 ...
	 *            set select.
	 */
	public void setSelect(final List<ZSelectItem> select) {
		this.select = select;
	}
	 ...
	 *            set from.
	 */
	public void setFrom(final List<ZFromItem> from) {
		this.from = from;
	}
	 ...
	 *            set order by.
	 */
	public void setOrderby(final List<ZOrderBy> orderby) {
		this.orderby = orderby;
	}
	...
	public boolean equals(Object o) {
		...
		return new EqualsBuilder().append(isDistinct(), query.isDistinct()).append(isForupdate(), query.isForupdate()).append(getSelect(), query.getSelect())
				.append(getFrom(), query.getFrom()).append(getWhere(), query.getWhere()).append(getGroupby(), query.getGroupby()).append(getSetclause(), query.getSetclause())
				.append(getOrderby(), query.getOrderby()).isEquals();
	}

	@Override
	public int hashCode() {
		return new HashCodeBuilder(17, 37).append(getSelect()).append(isDistinct()).append(getFrom()).append(getWhere()).append(getGroupby()).append(getSetclause())
				.append(getOrderby()).append(isForupdate()).toHashCode();
	}
}
